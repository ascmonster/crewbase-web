      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="mb-10 text-center">
            ...
            <p className="mt-2 text-sm text-zinc-500">Vendor portal</p>
          </div>
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-8 py-10 shadow-xl shadow-black/40 text-center">
            ...
            <h2 className="text-lg font-semibold text-white mb-3">Account Pending Approval</h2>
            <p className="text-sm text-zinc-400 mb-6">
              Your account is pending approval. We&apos;ll notify you by email once approved — usually within 24 hours.
            </p>
            <button
      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-8 py-10 shadow-xl shadow-black/40 text-center">
            ...
            <h2 className="text-lg font-semibold text-white mb-3">Account Rejected</h2>
            <p className="text-sm text-zinc-400 mb-6">
              Your account has been rejected. Contact{" "}
              <a href="mailto:hello@trycrewbase.com" className="text-[#FF6B35] hover:underline">
          ...
          <form onSubmit={handleSignIn} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="rounded-lg border border-white/[0.08] bg-white/[0.04] px-3.5 py-2.5 text-sm text-white placeholder:text-zinc-600 outline-none focus:border-[#FF6B35] focus:ring-1 focus:ring-[#FF6B35] transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 flex h-10 w-full items-center justify-center rounded-lg bg-[#FF6B35] text-sm font-medium text-white transition-colors hover:bg-[#ff7d4d] focus:outline-none focus:ring-2 focus:ring-[#FF6B35] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] disabled:opacity-50 disabled:cursor-not-allowed"
            >
